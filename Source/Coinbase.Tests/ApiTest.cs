...
namespace Coinbase.Tests
{
    ...
    public class ApiTests
    {
        ...
        public void ConstructorTests()
        {
            ...
            api.apiCheckoutUrl.Should().Be(CoinbaseUrls.LiveCheckoutUrl);
            ...
            api2.apiUrl.Should().Be(CoinbaseUrls.TestApiUrl);
            api2.apiCheckoutUrl.Should().Be(CoinbaseUrls.TestCheckoutUrl);
        }
    }
