...
namespace Coinbase
{
   ...
   public partial class CoinbaseApi : IBuysEndpoint
   {
      ...
      /// Lists buys for an account.
      /// </summary>
      Task<PagedResponse<Buy>> IBuysEndpoint.ListBuysAsync(string accountId, CancellationToken cancellationToken = default)
      {
      ...
      /// Get an individual buy.
      /// </summary>
      Task<Response<Buy>> IBuysEndpoint.GetBuyAsync(string accountId, string buyId, CancellationToken cancellationToken = default)
      {
         return this.AccountsEndpoint
      ...
      /// If you need to query the buy price without locking in the buy, you can use quote: true option.This returns an unsaved buy and unlike commit: false, this buy can’t be completed.This option is useful when you need to show the detailed buy price quote for the user when they are filling a form or similar situation.
      /// </summary>
      Task<Response<Buy>> IBuysEndpoint.PlaceBuyOrderAsync(string accountId, PlaceBuy placeBuy, CancellationToken cancellationToken = default)
      {
         return this.AccountsEndpoint
            .AppendPathSegments(accountId, "buys")
            .WithClient(this.client)
      ...
      /// The buy’s total will also be updated.You can repeat the /commit call to accept the new values and start the buy at the new rates.
      /// </summary>
      Task<Response<Buy>> IBuysEndpoint.CommitBuyAsync(string accountId, string buyId, CancellationToken cancellationToken = default)
      {
         return this.AccountsEndpoint
